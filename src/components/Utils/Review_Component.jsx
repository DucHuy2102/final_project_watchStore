        ...
        <div className='w-full rounded-lg bg-gray-100 dark:bg-gray-900 py-12'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='mb-5 flex justify-start items-center space-x-2'>
                    ...
                    <p className='mt-2 text-center text-xl font-semibold text-gray-800 dark:text-gray-200'>
                        Hãy cùng xem các khách hàng nói gì về dịch vụ và sản phẩm của WatcHes!
                    </p>
                    <div className='flex-grow mt-2 border border-gray-300 dark:border-gray-500' />
                </div>
                ...
                <div className='flex justify-end items-center space-x-2 mt-5'>
                    <div className='flex-grow mt-2 border border-gray-300 dark:border-gray-500' />
                    <span className='mt-2 text-center text-lg font-semibold sm:text-xl text-gray-600 dark:text-gray-300'>
