...
export default function OrderDetail({ orderData, onBack }) {
    ...
    const handleCancelOrder = async () => {
        try {
            setLoading(true);
            const res = await axios.put(`${import.meta.env.VITE_API_URL}/api/order/${orderData.id}`, {
                state: 'cancelled',
            });
            if (res.status === 200) {
                setOpenModal(false);
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <Card className='md:col-span-2'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <div className='flex justify-between font-bold text-blue-500 text-lg pt-2 border-t'>
